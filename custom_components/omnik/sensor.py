...
SENSOR_PREFIX = 'Omnik'
SENSOR_TYPES = {
    'status':            ['Status', None, 'mdi:check-network', None, None],
    'actualpower':       ['Actual Power', 'W', 'mdi:solar-power',DEVICE_CLASS_POWER, STATE_CLASS_MEASUREMENT],
    'energytoday':       ['Energy Today', 'kWh', 'mdi:lightning-bolt', DEVICE_CLASS_ENERGY, STATE_CLASS_TOTAL_INCREASING],
    ...
    'dcinputvoltage1':    ['DC Input Voltage 1', 'V', 'mdi:lightning-bolt', DEVICE_CLASS_VOLTAGE, STATE_CLASS_MEASUREMENT],
    'dcinputcurrent1':    ['DC Input Current 1', 'A', 'mdi:current-dc', DEVICE_CLASS_CURRENT, STATE_CLASS_MEASUREMENT],
    'dcinputvoltage2':    ['DC Input Voltage 2', 'V', 'mdi:lightning-bolt', DEVICE_CLASS_VOLTAGE, STATE_CLASS_MEASUREMENT],
    'dcinputcurrent2':    ['DC Input Current 2', 'A', 'mdi:current-dc', DEVICE_CLASS_CURRENT, STATE_CLASS_MEASUREMENT],
    'dcinputvoltage3':    ['DC Input Voltage 3', 'V', 'mdi:lightning-bolt', DEVICE_CLASS_VOLTAGE, STATE_CLASS_MEASUREMENT],
    'dcinputcurrent3':    ['DC Input Current 3', 'A', 'mdi:current-dc', DEVICE_CLASS_CURRENT, STATE_CLASS_MEASUREMENT],
    'acoutputvoltage1':   ['AC Output Voltage 1', 'V', 'mdi:lightning-bolt', DEVICE_CLASS_VOLTAGE, STATE_CLASS_MEASUREMENT],
    ...
    'acoutputpower1':     ['AC Output Power 1', 'W', 'mdi:lightning-bolt',DEVICE_CLASS_POWER, STATE_CLASS_MEASUREMENT],
    'acoutputvoltage2':   ['AC Output Voltage 2', 'V', 'mdi:lightning-bolt', DEVICE_CLASS_VOLTAGE, STATE_CLASS_MEASUREMENT],
    ...
    'acoutputpower2':     ['AC Output Power 2', 'W', 'mdi:lightning-bolt',DEVICE_CLASS_POWER, STATE_CLASS_MEASUREMENT],
    'acoutputvoltage3':   ['AC Output Voltage 3', 'V', 'mdi:lightning-bolt', DEVICE_CLASS_VOLTAGE, STATE_CLASS_MEASUREMENT],
    ...
    'acoutputpower3':     ['AC Output Power 3', 'W', 'mdi:lightning-bolt',DEVICE_CLASS_POWER, STATE_CLASS_MEASUREMENT],
  }
...
class OmnikData(object):
  ...
  def read_sensor(self, sensor_type):
    ...
    if sensor_type == "actualpower":
      if inverter_enabled == True:
        powers = [self.interface_inverter.get_acoutputpower(i) for i in range(1, 4)]
        value = sum(p for p in powers if p != -1)
      else:
        value = 0
